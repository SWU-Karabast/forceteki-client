...
export const fetchCosmeticsDataAsync = async (): Promise<Cosmetics> => {
    return {
        ...
        backgrounds: [
            { id: 'guid2', type: 'background', title: 'Default', path: s3ImageURL('ui/default-background.png') },
            { id: 'guid3', type: 'background', title: 'Spark of Rebellion Starfield', path: s3ImageURL(`${backgroundPrefix}/SWH01_Starfield.jpg`), darkened: true },
