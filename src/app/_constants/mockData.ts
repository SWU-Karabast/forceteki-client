...
export const articles: IArticle[] = [
    {
        ...
        content: `
        <p>Homeworlds (Set 9) cards are now playable in Premier & Eternal formats with the "Next Set" card pool. Use this mode to explore new strategies and deck combinations ahead of the official release.</p>
